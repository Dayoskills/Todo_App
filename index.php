...
<table class= "table">
    <tbody class="fs- text-primary shadow">
        ...
        <tr>
           ...
           <td style="width: 10%;"> <a href="delete.php?del_list=  <?php echo $row['id']; ?>" class="btn btn-outline-danger"><i class="fa-sharp fa-solid fa-trash"></i></a></td>
           <td style="width: 10%;"> <a href="update.php?update_list=  <?php echo $row['id']; ?>" class="btn btn-outline-success"><i class="fa-solid fa-pen"></i></a></td> 
        </tr>
        <?php $count++; } ?>
    </tbody>
</table>
